...
> [!WARNING]
> Ensure to use allow lists to avoid having to maintain an deny list on a continuous basis (as exclusion lists are a moving target) as per [pyscg-0047: Incomplete List Of Disallowed Input](../../04_neutralization/pyscg-0047/README.md).
