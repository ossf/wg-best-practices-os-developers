# pyscg-0016: Act on Error Conditions
...
Note that using `except Exception` is still too broad as per [pyscg-0015: Handle Exceptional Conditions](../pyscg-0015/README.md) and that a more specific exception handling is preferred.
