...
| **OpenSSF Open Source Security Baseline** | A [collection of secure development requirements](https://baseline.openssf.org/) for open source projects relative to their maturity level. . |
...
| 2025-03-28 | Refactor structure. Add terminology table |
